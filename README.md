...
Now add your password. (replace `GITHUB EMAIL` with the email you used to sign up for Github.)
...
If you don't have a key, run the following:
...
8. Create a new branch called `gh-pages`. GitHub uses this branch to push your code to your GitHub pages site. Branching is part of version control. You can do stuff on your branch and not affect the main code.
```
git checkout -b gh-pages
```

9. Push the `gh-pages` branch to GitHub
```
git push -f origin master gh-pages
```

10. Install all the modules for the portfolio site using npm
```
npm i --save
```
...
1. Open `deploy.sh`
2. Replace the `git@github.com` portion of the line `git push -f git@github.com-akowtko:akowtko/daniel-portfolio.git master:gh-pages`. Use the SSH path to your repo that you copied above. You can access it by clicking the `Clone or download` button the main page of your repo on GitHub.com.
...
I'll occasionally update my code, fixing bugs, responding to feedback or new features, etc. If you want access to these updates, you'll want to add my branch to your upstream. This basically meands that we're letting your branch know that there is anothe branch out there, outside of this repo, that it can communicate with and get updates from.
